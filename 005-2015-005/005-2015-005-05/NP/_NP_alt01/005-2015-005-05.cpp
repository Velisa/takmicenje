...
int main() {
  ...
  for (int i=0; i < takmicara; ++i) {
		...
		for (int j=0; j < pokusaja; ++j) {
			...
			if (pogodjeniR <= 1.0) bodova += 10;
			else if (pogodjeniR > 1.0 && pogodjeniR <= 2.0) bodova += 9;
			else if (pogodjeniR > 2.0 && pogodjeniR <= 3.0) bodova += 8;
			else if (pogodjeniR > 3.0 && pogodjeniR <= 4.0) bodova += 7;
			else if (pogodjeniR > 4.0 && pogodjeniR <= 5.0) bodova += 6;
			else if (pogodjeniR > 5.0 && pogodjeniR <= 6.0) bodova += 5;
			else if (pogodjeniR > 6.0 && pogodjeniR <= 7.0) bodova += 4;
			else if (pogodjeniR > 7.0 && pogodjeniR <= 8.0) bodova += 3;
			else if (pogodjeniR > 8.0 && pogodjeniR <= 9.0) bodova += 2;
			else if (pogodjeniR > 9.0 && pogodjeniR <= 10.0) bodova += 1;
		}
